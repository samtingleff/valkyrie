...
import com.othersonline.kv.backends.handlersocket.network.nio.impl.NioTCPSession;
import com.othersonline.kv.backends.handlersocket.network.util.LinkedTransferQueue;
...
public class HandlerSocketSessionImpl extends NioTCPSession implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.othersonline.kv.backends.handlersocket.network.hs.HandlerSocket#destroy()
	 */
	public void destroy() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.othersonline.kv.backends.handlersocket.network.hs.HandlerSocket#isAllowReconnect()
	 */
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerSocket#setAllowReconnect(boolean)
	 */
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerSocket#addCommand(com.google.code
	 * .hs4j.Command)
	 */
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerSocket#setCurrentCommand(com.google
	 * .code.hs4j.Command)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.othersonline.kv.backends.handlersocket.network.hs.HandlerSocket#getCurrentCommand()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.othersonline.kv.backends.handlersocket.network.hs.HandlerSocket#takeCurrentCommand()
	 */
