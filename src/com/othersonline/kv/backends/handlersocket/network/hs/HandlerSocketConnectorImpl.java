...
import com.othersonline.kv.backends.handlersocket.impl.IndexRecord;
import com.othersonline.kv.backends.handlersocket.impl.ReconnectRequest;
import com.othersonline.kv.backends.handlersocket.network.config.Configuration;
import com.othersonline.kv.backends.handlersocket.network.core.Controller;
import com.othersonline.kv.backends.handlersocket.network.core.ControllerStateListener;
import com.othersonline.kv.backends.handlersocket.network.core.EventType;
...
import com.othersonline.kv.backends.handlersocket.network.nio.NioSession;
import com.othersonline.kv.backends.handlersocket.network.nio.NioSessionConfig;
import com.othersonline.kv.backends.handlersocket.network.nio.impl.SocketChannelController;
import com.othersonline.kv.backends.handlersocket.network.util.SystemUtils;
...
public class HandlerSocketConnectorImpl extends SocketChannelController
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#setHealSessionInterval
	 * (long)
	 */
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#getHealSessionInterval()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#getProtocol()
	 */
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#addSession(com.google
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#removeSession(com.google
	 * .code.hs4j.network.core.Session)
	 */
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#addToWatingQueue(com
	 ...
	 * (non-Javadoc)
	 * 
	 * @seecom.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#connect(java.net.
	 * InetSocketAddress)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#getSessionList()
	 */
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#send(com.google.code
	 * .hs4j.Command)
	 */
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#isAllowAutoReconnect()
	 */
	 ...
	 * 
	 * @see
	 * com.othersonline.kv.backends.handlersocket.network.hs.HandlerCOnnector#setAllowAutoReconnect
	 * (boolean)
	 */
